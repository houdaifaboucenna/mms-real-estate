            ...
            <div id="estate">
                ...
                <div class="proj-show position-relative">
                  <div class="estate-img owl-carousel owl-theme proj-show-carousel">
                    @foreach (json_decode($estate->image) as $img)
                      <div class="item"><img class="lazyload blur-up" src="{{'/storage/'.$img}}" alt=""></div>
                    @endforeach
                  </div>
                </div>
                <div class="proj-thumbs position-relative">
                  <div class="owl-carousel owl-theme proj-thumbs-carousel nav-on-side">
                    @foreach (json_decode($estate->image) as $img)
                      <div class="item"><img class="owl-lazy" src="{{'/storage/'.$img}}" alt=""></div>
                    @endforeach
                  </div>
                </div>
                <div class="estate-info">
                  <div class="e-box">
                    <span class="iconify" data-icon="healthicons:city-outline" data-width="48" data-height="48"></span>
