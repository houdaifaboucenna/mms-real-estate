...
@section('content')
      <section id="homepage">
        ...
        <div class="row" id="home">
          ...
          <div class="col-md-3">
            <div id="filters">
              ...
              <form action="{{route('app.e_filter')}}" method="get">
                @csrf
                {{-- From --}}
                ...
                <div class="form-group text-center">
                  ...
                  <input type="text" class="js-range-slider" name="price_range" value="" id="price_range"
                      data-type="double"
                      data-min="0"
                      data-max="{{$maxPrice+(0.1*$maxPrice)}}"
                      data-from="{{$minPrice}}"
                      data-to="{{$maxPrice}}"
                  />
            ...
            <div id="home-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                @if ($settings->home_imgs)
                  @foreach (json_decode($settings->home_imgs) as $i => $img)
            ...
            <div class="row" id="box-row">
              <div class="col-md-4">
                <div class="box">
                  ...
                  <a href="{{route('app.posts_list')}}" class="btn pop">{{__('home.blog')}}</a>
                </div>
              </div>
              <div class="col-md-4">
                <div class="box">
            ...
            <div class="c-col">
              <div class="row">
                <div class="col-md-12 position-relative">
                  ...
                  <a href="{{route('app.estates_list')}}" class="all">{{__('home.all_estates')}} <span>({{$e_count}})</span></a>
                </div>
                    ...
                    <div class="estate">
                      ...
                      <div class="details">
                        ...
                        <div class="location">
                            ...
                            <a href="{{route('app.estate_city',$estate->city)}}"><span>{{$estate->getCity()}}</span></a>,
                            <a href="{{route('app.estate_town',[$estate->getCity(),($estate->town-1)])}}"><span>{{$estate->getTown()}}</span></a>
                        </div>
                        <p class="short">
                          @if (Session::get('applocale') == 'en')
                            {{$estate->short}}
            ...
            <div class="c-col">
              <div class="row">
                <div class="col-md-12 position-relative">
                  ...
                  <p>{{__('home.blog_text')}}</p>
                  <a href="{{route('app.posts_list')}}" class="all">{{__('home.all_articles')}} <span>({{$p_count}})</span></a>
                </div>
                @foreach ($posts as $post)
                  <div class="col-md-3 mb-2">
                    <div class="article">
                      ...
                      <div class="mt-2"><a href="{{route('app.post',$post->slug)}}"><span class="rdm">{{__('home.readmore')}}</span></a></div>
                    </div>
                  </div>
                @endforeach
              </div>
          ...
          <div class="col-md">
            <div class="c-col">
              <div class="row">
                <div class="col-md-12 position-relative">
                  <h2>{{__('home.faq')}}</h2>
                  <a href="{{route('app.faq')}}" class="all">{{__('home.all_faq')}} <span>({{$f_count}})</span></a>
                </div>
                    ...
                    @foreach ($faqs as $key => $faq)
                      <div class="card">
                        <div class="card-header" role="tab">
                          <h5 class="mb-0">
                            <a data-toggle="collapse" data-parent="#faqAcc" href="#faq-{{$key+1}}" aria-expanded="false" aria-controls="faq-{{$key+1}}" class="collapsed">
        ...
        <div id="pop_up">
          <button class="btn d-none pop_btn" type="button" data-toggle="modal" data-target="#pop-form">Content</button>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content border-0">
                <div class="modal-body p-0">
                    ...
                    {{-- Contact Form --}}
                    <form action="{{route('contacts.store')}}" id="c-form" method="POST" class="text-center mt-0">
                      @csrf
                      <h3>{{__('home.getin')}}</h3>
                      <p>{{__('home.fillin')}}</p>
