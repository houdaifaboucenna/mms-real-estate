            ...
            <div class="row infos" id="social">
              <div class="col-md-12">
                ...
                <div class="form-group d-flex align-items-center">
                  ...
                  <input id="facebook" class="form-control" type="url" name="facebook" value="{{ setting('facebook') }}">
                </div>
                <div class="form-group d-flex align-items-center">
                ...
                <div class="form-group d-flex align-items-center">
                  ...
                  <input id="twitter" class="form-control" type="url" name="twitter" value="{{ setting('twitter') }}">
                </div>
                <div class="form-group d-flex align-items-center">
                  <label for="youtube">{{ __('admin.youtube')}}<span class="asterix">*</span></label>
                  <input id="youtube" class="form-control" type="url" name="youtube" value="{{ setting('youtube') }}">
                </div>
                <div class="form-group d-flex align-items-center">
                  <label for="telegram">{{ __('admin.telegram')}}<span class="asterix">*</span></label>
                  <input id="telegram" class="form-control" type="url" name="telegram" value="{{ setting('telegram') }}">
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="enShort" role="tabpanel" aria-labelledby="enShort-tab">
                      <input id="short" class="form-control" type="text" name="desc" value="{{ setting('desc') }}">
                    </div>
                ...
                <div class="form-group">
                  ...
                  <ul class="nav nav-tabs" id="KeyTab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="enKey-tab" data-toggle="tab" href="#enKey" role="tab"
                        aria-controls="enKey" aria-selected="true">{{__('admin.en')}}</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="arKey-tab" data-toggle="tab" href="#arKey" role="tab" aria-controls="arKey"
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="arKey" role="tabpanel" aria-labelledby="arKey-tab">
                      <input id="keywords_ar" class="form-control" type="text" name="keywords_ar"
                        value="{{ setting('keywords_ar') }}" placeholder="key1, key2, key3, ....">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row infos" id="contact_info">
              <div class="col-md-12">
                ...
                <div class="form-group d-flex align-items-center">
                  ...
                  <input id="whatsapp" class="form-control" type="tel" name="whatsapp" value="{{ setting('whatsapp') }}">
                </div>
                <div class="form-group d-flex align-items-center">
                  <label for="phone">{{ __('admin.phone')}}<span class="asterix">*</span></label>
                  <input id="phone" class="form-control" type="tel" name="phone" value="{{ setting('phone') }}">
                </div>
                <div class="form-group d-flex align-items-center">
