                    ...
                    <form method="post" action="{{ route('settings.update') }}" enctype="multipart/form-data"
                        ...
                        <div class="clone-item d-none">
                            <div class="slider-item add">
                                ...
                                <label class="file_img" href="#">
                                    <input type="file" name="home_imgs[]" class="form-control"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="slider">
                                    ...
                                    @if (setting('home_imgs'))
                                        @foreach (json_decode(setting('home_imgs')) as $img)
                        ...
                        <div class="row infos" id="social">
                            <div class="col-md-12">
                                ...
                                <div class="form-group d-flex align-items-center">
                                    <label for="instagram">{{ __('admin.instagram') }}<span
                                ...
                                <div class="form-group d-flex align-items-center">
                                    ...
                                    <input id="telegram" class="form-control" type="url" name="telegram"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <ul class="nav nav-tabs" id="shortTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="enShort-tab" data-toggle="tab"
                                                href="#enShort" role="tab" aria-controls="enShort"
                                                aria-selected="true">{{ __('admin.en') }}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="arShort-tab" data-toggle="tab" href="#arShort"
                                                role="tab" aria-controls="arShort"
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="enShort" role="tabpanel"
                                            ...
                                            <input id="short" class="form-control" type="text" name="desc"
                                                value="{{ setting('desc') }}">
                                        </div>
                                        <div class="tab-pane fade" id="arShort" role="tabpanel"
                                            aria-labelledby="arShort-tab">
                                            <input id="short_ar" class="form-control" type="text" name="desc_ar"
                                                value="{{ setting('desc_ar') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <ul class="nav nav-tabs" id="KeyTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="enKey-tab" data-toggle="tab" href="#enKey"
                                                role="tab" aria-controls="enKey"
                                                aria-selected="true">{{ __('admin.en') }}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="arKey-tab" data-toggle="tab" href="#arKey"
                                                role="tab" aria-controls="arKey"
                                                aria-selected="false">{{ __('admin.ar') }}</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="enKey" role="tabpanel"
                                            ...
                                            <input id="keywords" class="form-control" type="text" name="keywords"
                                                value="{{ setting('keywords') }}" placeholder="key1, key2, key3, ....">
                                        </div>
                                        <div class="tab-pane fade" id="arKey" role="tabpanel"
                                            aria-labelledby="arKey-tab">
                                            <input id="keywords_ar" class="form-control" type="text"
                                                name="keywords_ar" value="{{ setting('keywords_ar') }}"
                        ...
                        <div class="row infos" id="contact_info">
                            <div class="col-md-12">
                                ...
                                <div class="form-group d-flex align-items-center">
                                    <label for="whatsapp">{{ __('admin.whatsapp') }}<span
                                            class="asterix">*</span></label>
                                    <input id="whatsapp" class="form-control" type="tel" name="whatsapp"
