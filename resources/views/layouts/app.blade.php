...
<body id="home">
  <div id="app">
            ...
            <div class="upper-nav">
              <form class="form-inline search-top" action="{{route('app.search')}}" method="GET">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="{{__('home.search')}}" name="q"
              ...
              <div class="n-social">
                <a href="{{setting('facebook')}}"><span class="iconify" data-icon="cib:facebook"></span></a>
                <a href="{{setting('instagram')}}"><span class="iconify" data-icon="cib:instagram"></span></a>
                <a href="{{setting('twitter')}}"><span class="iconify" data-icon="cib:twitter"></span></a>
                <a href="{{setting('telegram')}}"><span class="iconify" data-icon="cib:telegram"></span></a>
                <a href="{{setting('linkedin')}}"><span class="iconify" data-icon="cib:linkedin"></span></a>
              </div>
            </div>
          ...
          <ul>
            @foreach (App\Models\Estate::types() as $i => $type)
              <a href="{{route('app.estate_type', $i)}}">
                <li>{{$type}} <span>({{App\Models\Estate::where('type', $i)->count()}})</span> </li>
              </a>
            @endforeach
          </ul>
        </div>
    ...
    {{-- Scroll Top --}}
    <button onclick="topFunction()" id="scrTop"><span class="iconify" data-icon="cil:arrow-top" data-width="24"
        data-height="24"></span>
    </button>
