...
<body id="home">
    <div id="app">
                  ...
                  <ul class="navbar-nav">
                    <div class="upper-nav">
                        ...
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">
                              <span class="iconify" data-icon="ci:search" data-height="20" data-width="20"></span>
                            </span>
                          </div>
                          <input type="text" class="form-control" placeholder="{{__('home.search')}}" name="q" aria-describedby="basic-addon1">
                        </div>
                      </form>
                      <div class="n-tel">
                      ...
                      <div class="n-whatsapp">
                        <a href="https://wa.me/{{str_replace(' ','',$settings->whatsapp)}}" target="_blank">
                          <span class="iconify" data-icon="bi:whatsapp"></span>
                          <span class="num">{{$settings->whatsapp}}</span>
                        </a>
                      </div>
                      <div class="n-social">
                        <a href="{{$settings->facebook}}"><span class="iconify" data-icon="cib:facebook"></span></a>
                        <a href="{{$settings->instagram}}"><span class="iconify" data-icon="cib:instagram"></span></a>
                        <a href="{{$settings->twitter}}"><span class="iconify" data-icon="cib:twitter"></span></a>
                        <a href="{{$settings->telegram}}"><span class="iconify" data-icon="cib:telegram"></span></a>
                        <a href="{{$settings->linkedin}}"><span class="iconify" data-icon="cib:linkedin"></span></a>
                      </div>
                    </div>
                    ...
                    <div class="lower-nav">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('app.estates_list') }}">{{ __('home.properties') }}</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('app.posts_list') }}">{{ __('home.blog') }}</a>
                      </li>
                      <li class="nav-item">
        ...
        <footer class="container-fluid py-4">
            <div class="row p-4">
              <div class="col-md-3" id="fs-logo">
                <a href="{{route('app.home')}}"><img src="{{asset('images/logo1.png')}}" alt="" class="logo-f"></a>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                ...
                <ul>
                  @foreach (App\Models\Estate::types() as $i => $type)
                    <a href="{{route('app.estate_type',$i)}}"><li>{{$type}} <span>({{App\Models\Estate::where('type',$i)->count()}})</span> </li></a>
                  @endforeach
                </ul>
              </div>
              <div class="col-md-3" id="fs-contact">
                ...
                <ul class="n-social mt-3 mb-1">
                  <li class="pop"><a href="{{$settings->facebook}}"><span class="iconify" data-icon="cib:facebook"></span></a></li>
                  <li class="pop"><a href="{{$settings->instagram}}"><span class="iconify" data-icon="cib:instagram"></span></a></li>
                  <li class="pop"><a href="{{$settings->twitter}}"><span class="iconify" data-icon="cib:twitter"></span></a></li>
                  <li class="pop"><a href="{{$settings->telegram}}"><span class="iconify" data-icon="cib:telegram"></span></a></li>
                  <li class="pop"><a href="{{$settings->linkedin}}"><span class="iconify" data-icon="cib:linkedin"></span></a></li>
                </ul>
        ...
        {{-- Scroll Top --}}
        <button onclick="topFunction()" id="scrTop"><span class="iconify" data-icon="cil:arrow-top" data-width="24" data-height="24"></span>
        </button>
    ...
    <script>
      function getIp(callback) {
        fetch('https://ipinfo.io/json?token=7221af36e45b9a', { headers: { 'Accept': 'application/json' }})
          .then((resp) => resp.json())
          .catch(() => {
            return {
              country: 'tr',
